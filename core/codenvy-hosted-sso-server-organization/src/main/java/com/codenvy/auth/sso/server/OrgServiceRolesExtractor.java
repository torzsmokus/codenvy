...
public class OrgServiceRolesExtractor implements RolesExtractor {
    ...
    @Inject
    public OrgServiceRolesExtractor(PreferencesManager preferencesManager,
    ...
    public Set<String> extractRoles(AccessTicket ticket) {
        ...
        try {
            ...
            final Map<String, String> preferences = preferencesManager.find(ticket.getPrincipal().getUserId());
