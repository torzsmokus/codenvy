...
/**
 * MongoDB implementation of {@link }
 * <p>
 * Storage schema:
 * <pre>
 * {
...
@Singleton
public class MongoDBFactoryStore {
...
//
//    @Override
//    public FactoryIm getFactory(String factoryId) throws NotFoundException, ServerException {
//        if (factoryId == null) {
//            throw new NullPointerException("The factory Id shouldn't be null");
//        }
...
//    @Override
//    public Set<FactoryImage> getFactoryImage(String factoryId, String imageId) throws NotFoundException {
//        if (factoryId == null) {
